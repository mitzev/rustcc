...
pub use cxx_exception::{
    collect_throws_catches, decode_cxx_raw_error, render_all_throws_shims_cpp,
    render_throws_shim_cpp, render_throws_shim_cpp_typed, CxxException, CxxExceptionKind,
    CxxRawError, ThrowsShimSpec, CXX_EXC_OK, CXX_EXC_STD, CXX_EXC_TYPED_BASE, CXX_EXC_UNKNOWN,
