...
pub use cxx_exception::{
    collect_class_method_throws_catches, collect_throws_catches, decode_cxx_raw_error,
    render_all_throws_shims_cpp, render_throws_shim_cpp, render_throws_shim_cpp_typed,
    CxxException, CxxExceptionKind, CxxRawError, ThrowsShimSpec, CXX_EXC_OK, CXX_EXC_STD,
    CXX_EXC_TYPED_BASE, CXX_EXC_UNKNOWN, CXX_RAW_ERROR_HEADER,
};
...
pub use import::{
    ...
    import_header_with_annotations, import_header_with_extras, synthesize_stl_companions,
    ImportExtras,
};
